    ...
    public function definition(): array
    {
        return [
            ...
            'model_id' => function (array $attributes) {
                Model::where('maker_id', $attributes['maker_id'])->inRandomOrder()->first()->id;
            },
            'year' => $this->faker->year(),
            'price' => $this->faker->randomFloat(2, 1000000, 10000000),
            'vin' => strtoupper(Str::random(17)),
            'milage'=> fake()-> randomFloat(2, 5, 500) * 1000,
            ...
            'phone' => function(array $attributes) {
                User::find($attributes['user_id'])->phone;
            },
            'description' => fake()->text(2000),
            'published' => $this->faker->optional(0.9)->dateTimeBetween('1 month', '+1 day'),
